...
--
-- Table structure for table `guineapig`
--
...
--
-- Dumping data for table `guineapig`
--

LOCK TABLES `guineapig` WRITE;
/*!40000 ALTER TABLE `guineapig` DISABLE KEYS */;
/*!40000 ALTER TABLE `guineapig` ENABLE KEYS */;
UNLOCK TABLES;
